...
<div class="container col-xxl-8 px-4 py-5">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-6">
        ...
        <p class="lead">Estamos aquí para traer a la realidad tus sueños, con todos los detalles que nos proporciones. Comenzamos escuchando tus ideas, visitando el lugar, tomando medidas y preparando una galeria de imagenes y videos renders que te acercaran a la visión de poder cumplir ese sueño.
...
<div class="container col-xxl-8 px-4 py-5">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-6">
        ...
        <p class="lead">Tenemos las capacidades, las herramientas y los equipos para construir proyectos de todas las escalas, desde casa sencillas, hasta grandes construcciones como edificios, aeropuertos y más. El único limite es la imaginación, y mientras puedas imaginarlo podemos construirlo.
¿Quieres remodelar tu cocina o baño? Llámanos.
¿Aburrido de tu closet? Tenemos a los mejores carpinteros.
¿Necesitas un portón para tu negocio? Somos especialistas en hierro.
