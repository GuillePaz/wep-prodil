...
<div class="accordion" id="accordionPanelsStayOpenExample">
  <div class="accordion-item">
    ...
    <button class="accordion-button collapsed bg-dark text-white" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
        <img class="img-icon" src="<?php echo PRODUCTOS."/procom.png"?>" alt="">
        <H3>PROCOM</H3>
      </button>
    </h2>
    <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse">
      <div class="accordion-body">
        <h4>Diseños de Proyectos de Ingeniería, Cálculo de Cómputos y Elaboración de Presupuestos</h4>
        <p><b>Fase 1 - </b> SISTEMATIZACIÓN DEL REQUERIMIENTO (LEVANTAMIENO DE LA INFORMACIÓN DEL CLIENTE)</p>
